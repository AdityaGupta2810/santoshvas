...
<div class=" w-full  p-4 h-screen flex  bg-cover justify-between bg-center items-center">
...
<form class="flex justify-start flex-col w-full " method="post" action="../actions/adminlogaction.php">
   
<input class=" w-full p-3 mb-5  border-2 border-gray-400 rounded-lg placeholder:font-medium outline-none  focus:ring-blue-500 focus:ring-1" name="uemail" id="user" type="email" placeholder="Email" required>
 <input class=" w-full p-3 mb-5  border-2 border-gray-400 rounded-lg placeholder:font-medium outline-none focus:ring-blue-500 focus:ring-1" id="pass" name="upass" type="password" placeholder="Password" required>
 ...
 <button class=" p-3 mb-5 bg-blue-600 rounded-lg border-0 w-full outline-none focus:ring-2 focus:ring-blue-500 ring-offset-2" type="submit">Login</button>
