...
?>
<!-- <body class="container flex justify-center items-center bg-[url('./Home/images/logiback.webp')] bg-cover bg-center " >  for bg - image --> 
<body class="container flex justify-center items-center bg-gradient-to-r from-blue-500 to-purple-600 h-screen " >
